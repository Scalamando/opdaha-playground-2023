...
<template>
  ...
  <div>
    <Swiper :slides-per-view="1.15" :space-between="8" centered-slides centered-slides-bounds css-mode class="mb-4"
      v-viewer.static="{ toolbar: false, navbar: false, title: (img: HTMLImageElement) => img.alt }">
      <SwiperSlide v-for="(image, index) in images" :key="index">
        <img :src="image.url" width="500" height="250" :alt="'Ein Bild von einem Spielplatz'"
  ...
  <div class="p-2">
    ...
    <div class="flex py-4">
      <div v-for="alert in alerts" class="flex border-2 border-solid rounded-md m-2 p-2 text-cente w-full"
        :class="{ 'border-rose-400, text-rose-400': alert.type === 'warning', 'border-blue-400, text-blue-400': alert.type === 'message' }">
    ...
    <va-button class="flex w-full justify-center mt-8">
      <div class="w-full">
